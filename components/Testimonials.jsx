...
const TESTIMONIALS = [
  { text: "Zarcone Photography is truly the best! Tom has an incredible passion for what he does, and it comes through in every single shot he captures. Some of my absolute favorite pictures of my daughter are the wrestling match photos he took. If you need someone who genuinely cares about their craft and delivers unforgettable images, Zarcone Photography is your guy!", name: 'Katie Kelly' },
  { text: "Tom at Zarcone Photography is simply outstanding! His talent, creativity, and professionalism are second to none. The quality of his photography and graphic design work has taken BRHS Wrestling's social media presence to another level — every photo captures the intensity and emotion of the sport, and his graphics consistently look sharp, professional, and engaging. Beyond the work itself, Tom is reliable, easy to work with, and genuinely cares about delivering the best results. Whether it's sports, events, portraits, or branding, I can't recommend Zarcone Photography highly enough.", name: 'Kyle Murphy, Head Wrestling Coach — BRHS' },
  { text: "Working with Zarcone Photography has been an outstanding experience for our school community. Tom is the consummate professional — organized, dependable, and committed to representing our students, athletes, and programs in the best possible light. Communication is excellent, deadlines are always met, and every interaction reflects a true partnership. We highly recommend Zarcone Photography to any school or organization looking for a professional photographer who delivers exceptional results.", name: 'Peter Engel' },

    ...
    <>
      ...
      <section className={styles.story}>
        ...
        <div className={`${styles.storyBody} reveal`}>
          ...
          <p>Team and league coverage — full-season galleries, sideline access, athlete highlight reels — runs through my sports media brand, <a href="https://www.yourbestshot.photos" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>Your Best Shot</a>.</p>
        <p>For schools and athletic programs, that coverage has grown into something bigger than photography — a full media partnership. I build and maintain program-owned Media Hubs (schedules, scores, stats, photo and video galleries, social content) for partner programs like Bridgewater-Raritan Panther Football, alongside the on-the-ground photography and design work. It's the same commitment to showing up and getting it right — just applied to everything a program needs, not only the pictures.</p>

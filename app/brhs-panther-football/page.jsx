...
const ARTICLES = [
  ...
  { title: 'NJ Football Rankings: Bridgewater-Raritan Holds At No. 9 In Big Central Conference Top 15, Week 2', source: 'MyCentralJersey', url: 'https://www.mycentraljersey.com/story/sports/high-school/football/2026/09/14/nj-football-rankings-in-big-central-conference-the-top-15-week-2/91605423007/', date: '2026-09-14' /* added 2026-09-15, Tom-flagged via screenshot + direct URL — same access pattern as the Week 2 picks entry below (mycentraljersey.com story URLs are blocklisted for automated fetch; Tom sent the article link directly). Byline: Andy Mendlowitz and Simeon Pincus, MyCentralJersey.com, updated 2026-09-14 4:29 p.m. ET. Weekly Big Central Conference Top 15 poll (FOOTBALL-SOURCES.md item 9's "weekly conference Top 15 poll," not previously cited on the page). BR holds at No. 9 (unchanged from the prior week's poll), with the blurb crediting the 40-14 win over Hillsborough (JB Baxter piloting the offense, Jahmier Black leading the ground game) and previewing the Sep 18 home game vs. Ridge (2-0) at Basilone Field — consistent with SCHEDULE_2026 and STAT_BAR elsewhere on the page. Content transcribed from Tom's own screenshot rather than an automated fetch. */ },
  { title: 'Pincus And Mendlowitz Predict Bridgewater-Raritan To Beat Hillsborough In Week 2 Big Central Conference Picks', source: 'MyCentralJersey', url: 'https://www.mycentraljersey.com/story/sports/high-school/football/2026/09/10/nj-football-predictions-from-pincus-and-mendlowitz-for-bcc-week-2/91601870007/', date: '2026-09-10' /* added 2026-09-10, Tom-flagged via screenshots + direct URL — this is FOOTBALL-SOURCES.md's item 9a (Pincus/Mendlowitz's weekly BCC picks column), first identified 2026-09-04 but not directly fetchable in-session (mycentraljersey.com story URLs are blocklisted for automated fetch — same paywall/access gap already noted in the checklist; Tom has an active login). Byline: Andy Mendlowitz and Simeon Pincus, MyCentralJersey.com, updated 2026-09-10T18:09 ET. Previews tomorrow's Sep 11 home opener vs. Hillsborough (framed as "No. 10 Hillsborough (1-1) at No. 9 Bridgewater-Raritan (1-1), 4 p.m.") — both writers pick BR to win: Pincus 29-21, Mendlowitz 24-18. Analysis notes BR "pushed the conference's No. 1 ranked team [St. Joseph] to the brink" in the Week 2 loss and shows "there hasn't been much of a drop off" after graduation losses from the 2025 sectional-title team; calls Hillsborough's form harder to judge (lost its opener to Shore power Manalapan, then a closer-than-expected 21-14 win over Hunterdon Central). Content transcribed directly from Tom's own logged-in screenshots, not an automated fetch — see FOOTBALL-SOURCES.md item 9a for the access-limitation note this resolves. */ },
  { title: "Bridgewater-Raritan High School's Football Team Fell Short In A Thrilling 43-36 Loss To St. Joseph (Metuchen)", source: 'BRRSD Athletics', url: 'https://www.brrsd.org/o/brrhs/article/3115567', date: '2026-09-05' /* added 2026-09-06 sweep, found via BRRSD's news feed (Tier 1 #2). Confirms the same 43-36 final and adds detail not elsewhere on the page: BR led 29-28 before St. Joseph answered with a go-ahead score, 35-29, with 8:05 left in the 4th; St. Joseph entered 8-2 last year and is "ranked among the top teams in the Big Central Conference." NOTE: BRRSD's own headline calls the opponent "St. Joseph Regional High School" — that's actually the name of a different, well-known NJ program (St. Joseph Regional in Montvale, Bergen County); the article body itself says "in Metuchen," confirming it means St. Joseph (Metuchen), the same opponent as the CJSR recap below and everywhere else on this page. Title here corrected to avoid the mixup; see FOOTBALL-SOURCES.md for the naming-trap note. */ },
  { title: 'No. 2 St. Joseph-Metuchen Takes Early Lead, Then Rallies For 43-36 Win Over No. 6 Bridgewater-Raritan', source: 'CJ Sports Radio', url: 'https://cjsportsradio.com/2026/09/05/no-2-st-joseph-metuchen-takes-lead-early-lead-then-rallies-for-43-36-win-over-no-6-bridgewater-raritan/', date: '2026-09-05' /* added 2026-09-05 (2nd sweep run), article:published_time confirmed 2026-09-05T22:26:55Z. Week 2 recap: BR (1-1) lost 43-36 at Brenner Family Field, Metuchen — trailed 14-0 and 21-8 at half, fell behind 28-15 in the 3rd, then rallied on 3 more Jahmier Black rushing TDs (9-yd, a 26-yd score that gave BR its first lead at 29-28, and a 1-yd TD at 2:47) plus a Jonathan Okolo score off a James LoCrotondo interception, but St. Joseph (No. 2, unbeaten in season openers under coach Bill Tracy since 2023) answered with 15 unanswered points, including a Dominic Rodriguez INT setting up the game-sealing score, and forced a turnover on downs on BR's final drive after a recovered onside kick. Independently corroborated by MaxPreps' own box score (PF 36/PA 43); no TAPinto/MyCentralJersey recap had published yet as of this sweep — same-day publish lag, consistent with pattern (added if/when one surfaces on a future sweep). Result also filled into SCHEDULE_2026 and a Week 2 box score into lib/footballStats.js the same session. */ },
  ...
  { title: 'Football: Bridgewater-Raritan Beats Woodbridge, 28-7, in Opening Game', source: 'TAPinto', url: 'https://www.tapinto.net/towns/woodbridge-slash-carteret/sections/sports/articles/football-bridgewater-raritan-beats-woodbridge-28-7-in-opening-game', date: '2026-08-29' /* added 2026-08-29, Tom-flagged (opponent-side local coverage of the same Aug 28 opener). Published via TAPinto's Woodbridge/Carteret edition, not BR's own — full scoring-play sequence: Baxter's 47-yd TD pass to Evan Woodring (1Q); Woodbridge tied it 7-7 on a Dylan Stephen 28-yd TD run (2Q); Baxter's 64-yd TD pass to Jack Winne put BR ahead for good (2Q); Jahmier Black's 3-yd TD run (3Q); Baxter's 3rd TD pass, 30 yds to Jasper Schwamberger (4Q). Kept alongside CJSR's recap above rather than reconciled — see the 47-vs-48-yd note on the Woodring TD in lib/footballSchedule.js. NOTE (2026-08-29 sweep): this same article also appears mirrored on TAPinto's own Bridgewater/Raritan edition at .../towns/bridgewater-slash-raritan/.../football-bridgewater-raritan-beats-woodbridge-28-7-in-opening-game-3 — confirmed via its canonical tag to be the identical article (not a second independent source), and its body text agrees with 47 yds on the Woodring catch. Noted here since it tips the 47-vs-48 count 3-to-1 toward 47, though per Tom's standing call the two recaps are kept as-is rather than reconciled. */ },
  { title: 'Bridgewater-Raritan Football Looking to Continue Success Following Best Season in Eight Years', source: 'TAPinto', url: 'https://www.tapinto.net/towns/bridgewater-slash-raritan/sections/sports/articles/bridgewater-raritan-football-looking-to-continue-success-following-best-season-in-eight-years', date: '2026-08-26' /* added 2026-08-29 via general-web-search sweep — previously missed by every prior sweep despite being on TAPinto's own BR edition (Tier 1 source). Date is an estimate: article references the Aug. 27 Woodbridge opener in future tense, so it predates kickoff; exact publish timestamp not exposed by TAPinto's page (same metadata gap already documented in VOLLEYBALL-SOURCES.md). Preseason piece: Catalano entering his 4th year, program coming off "its most successful season in eight years" (9-4, first-ever sectional title) — consistent with, not contradicting, everything else already on the page. */ },
  ...
  { title: 'Panther Alum Colin Kurdyla (Class of 2023) Closes Out Rutgers Lacrosse Season As Big Ten Scoring Leader — 30G/27A/57PTS, Second Team All-Big Ten', source: 'Rutgers University Athletics', url: 'https://scarletknights.com/news/2026/7/9/mens-lacrosse-mens-lacrosse-2026-season-recap', date: '2026-07-09' /* updated 2026-09-01 via brhs-alumni-watch — supersedes the 2026-03-17 mid-season entry below with Rutgers' own official season-recap article, published after Kurdyla's 2026 season concluded. Final totals: 30 goals, 27 assists, 57 points (up from the in-season 27/23/50 snapshot), leading the Big Ten in both points (3.8) and assists (1.8) per game. Two program-history single-game marks: 4G/7A (11 points) vs. St. John's — RU's first 11-point game since 1993 and the most assists by a Rutgers player in a game since 1997 — then 4G/5A (9 points) vs. Bellarmine, making him the first RU player ever with two 9-plus-point games in a single season. Final honors confirmed via this recap: 2026 Second Team All-Big Ten, 2026 Honorable Mention All-American (Media), Tewaaraton Award Watch List, USILA Team of the Week, National Player of the Week and Big Ten Offensive Player of the Week (both 3/17/26). Original discovery: first read of PJR's Team Preview 2023 (Post 1,134) surfaced Kurdyla as a BRHS football WR/DB grad previously unknown to this tracker; a same-surname family member, Cam Kurdyla (NJIT lacrosse, Class of 2024), is already covered above. Off-sport for a football-alumni page, same precedent as the Cam Kurdyla and "Panther Plans" entries. See PANTHER-ALUMNI.md Class of 2023 for full detail. */ },

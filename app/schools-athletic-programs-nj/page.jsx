...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://zarconephotography.com/photos/BLOG_BRHSFootBallMediaPartner.png',
        width: 1200,
        height: 800,
        alt: 'Zarcone Photography — official media partner, BRHS Panther Football',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['https://zarconephotography.com/photos/BLOG_BRHSFootBallMediaPartner.png'],
  },
  alternates: {
...
const jsonLd = {
  ...
  offers: {
    '@type': 'Offer',
    priceCurrency: 'USD',
    description: 'Custom season media partnership pricing — Gold Sponsor level and organizational licensing available on request.',
  },
};
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Both. Some partnerships cover a single program for a season — like the current BRHS Panther Football partnership — others cover multiple sports across a school year. Multi-sport and multi-year rates are available.',
  },
  {
...
const PREVIEWS = [
  '/photos/BLOG_BRHSFootBallMediaPartner.png',
  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="A dedicated media partner for your program's season — game coverage, team portraits, Senior Night, and imagery built to represent your athletes well. Based in Bridgewater, NJ."
      ...
      <section className={styles.intro}>
        ...
        <div className={styles.introBody}>
          ...
          <p>Currently the official media partner and a Gold Level Sponsor of BRHS Panther Football for the 2026 season — full details in the <Link href="/blog/brhs-panther-football-2026-media-partnership">partnership announcement</Link>.</p>
        </div>
      </section>

      {/* Proof point strip */}
      <div className={styles.locations}>
        <span className={styles.locationsLabel}>Current Partnership</span>
        <p className={styles.locationsList}>
          Official Media Partner &amp; Gold Level Sponsor — BRHS Panther Football, 2026 Season &nbsp;·&nbsp; Media Day, full home-game coverage, Senior Night posters, and postseason coverage on Big State Sports.
        </p>
      </div>

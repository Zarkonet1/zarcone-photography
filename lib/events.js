...
const RAW_EVENTS = [
  ...
  {
    title:       'Make-Up Individual Photo Day',
    badge:       'Official Media Partner',
    date:        'August 11, 2026',
    dateISO:     '2026-08-11',
    location:    'Bridgewater-Raritan High School · Basilone Fieldhouse',
    description: "A second shot for any Panther who missed Media Day on July 29 — individual portraits following practice, approx. 1:30 PM. Players should bring a towel, comb/brush, and a clean t-shirt to change into.",
    image:       '/photos/media-day-varsity-coaches.jpg',
    link:        '/brhs-panther-football',
    linkLabel:   'See the Partnership',
    team:        'football',
  },
  {
    title:       'Panther Football Family Day',
    badge:       'RSVP Event',
    date:        'August 30, 2026',
    dateISO:     '2026-08-30',
    location:    'Green Knoll Grill · Bridgewater, NJ',
    description: "Come celebrate with past, present, and future football families — late lunch or early dinner starting 1:30 PM, with live music from Black Dog 3–6 PM. The $10 door fee is waived for BR football families who RSVP in advance.",
    image:       '/photos/brhs-football-kickoff-2026-flyer.jpg',
    link:        'mailto:BRfootball26@gmail.com?subject=Family%20Day%20RSVP',
    linkLabel:   'RSVP to Attend',
    team:        'football',
  },
  {
    title:       'Wagner Farm Arboretum Harvest Festival & Artisan Market',
    badge:       'Vendor',
    date:        'September 26, 2026',
    dateISO:     '2026-09-26',
    location:    'Wagner Farm Arboretum · 197 Mountain Ave, Warren, NJ',
    description: "Zarcone Photography is a confirmed artisan vendor at Wagner Farm's inaugural Harvest Festival & Artisan Market, presented by NextHome Premier — a day of fall fun for the whole family, 10 AM–4 PM, rain or shine, set against the Arboretum's iconic red silos. Free admission, with an artisan market, food trucks, live music, and family activities all day. Stop by our booth for prints and portrait bookings — we'll be shooting the festival itself too.",
    image:       '/photos/wagner-farm-harvest-festival-2026.jpg',
    link:        'https://www.wfafnj.org/wfaharvestfestival',

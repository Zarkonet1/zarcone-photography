...
// guess, `league: true` here is derived independently from the Big North
// Conference / Super Football Conference "American Red" division roster
// (Wikipedia, North Jersey Super Football Conference, cross-checked
// 2026-08-27): Dumont, Mahwah, Pascack Hills, Ramsey, Ridgefield Park,
// Westwood Regional. Of Mahwah's 8 opponents, three are American Red
// members — Dumont, Ramsey, Westwood — and are flagged `league: true`
// below; the other five (Pequannock, Lakeland Regional, New Milford,
// Hanover Park, Fair Lawn) are Super Football Conference crossover games
// from other divisions, not flagged. Same division-membership-inference
// method BRHS's own footballSchedule.js/page.jsx already uses for its
// non-schedule-derived standings rows — see OTHER_STANDINGS in that file.
//
...
export const MAHWAH_SCHEDULE_2026 = [
  ...
  { date: 'Fri, Sep 18', time: '7:00 PM', opponent: 'vs Lakeland Regional', home: true, location: HOME_FIELD, result: null },
  ...
  { date: 'Fri, Oct 23', time: '7:00 PM', opponent: 'at Westwood Regional', home: false, league: true, location: 'TBD — confirm venue (Westwood Regional HS)', result: null },
];

...
export const WHY_ZARCONE = {
  ...
  paragraphs: [
    ...
    'Led by West Point graduate and Army veteran Tom Zarcone, the company applies military discipline, operational planning, attention to detail, and owner-led execution to more than four decades of photographic experience.',
  ],
...
export const CORE_COMPETENCIES = [
  { title: 'Mission Documentation & Visual Records', description: 'Comprehensive visual record-keeping for institutional missions, programs, and operations.' },
  { title: 'Official Ceremonies & Executive Events', description: 'Official events, recognitions, commemorations, conferences, and organizational milestones, documented with institutional context and accuracy.' },
...
export const INSTITUTIONAL_PARTNERSHIPS = {
  ...
  items: [
    ...
    // Press-assignment work, not a direct municipal client relationship —
    // TAPinto/the Breeze credited these, the townships did not commission
    // them. Verified live against the published articles on 2026-07-20;
    // do not soften into a "served municipalities" claim. Sources:
    // - tapinto.net/.../bridgewater-township-celebrates-national-night-out (National Night Out, Bridgewater Twp, published 8/4/23, event 8/1/23)
    // - tapinto.net/.../raritan-honors-9-11-victims-with-annual-ceremony (9/11 Ceremony, Raritan Borough, published 9/12/25, event 9/11/25)
    // - tapinto.net/.../raritan-township-honors-service-members-lost-in-war-during-memorial-day-ceremony (Memorial Day, Raritan Twp/Hunterdon, published 6/1/21, event 5/31/21)
    // - tapinto.net/.../raritan-township-police-celebrates-national-night-out-photo-gallery (National Night Out, Raritan Twp/Hunterdon, published 8/9/21, event 8/3/21)
    'Municipal Government Event Coverage (Press Assignment): Photo credit for official municipal ceremonies and civic events in Bridgewater Township, Raritan Borough, and Raritan Township — National Night Out, 9/11 Remembrance Ceremony, and Memorial Day Ceremony — published via TAPinto the BReeze and TAPinto Flemington-Raritan, 2021–2025.',
  ],
};

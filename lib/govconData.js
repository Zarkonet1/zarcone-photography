...
// Public verification links for the Certifications section. Confirm the
// SAM.gov entity profile is set to public/searchable before launch — see
// GOVCON-LANDING-PAGE-SPEC.md §10, item 4.
export const VERIFICATION_LINKS = {
  samGov: 'https://sam.gov/search/?index=_all&keywords=W9L7BJ4DAA64',
  sdvosbVetCert: 'https://veterans.certify.sba.gov/',
};
...
export const HERO = {
  ...
  subhead:
    'Zarcone Photography LLC is a Service-Disabled Veteran-Owned Small Business providing professional visual documentation for events, ceremonies, executive portraiture, and public affairs. SAM.gov registered and SBA-certified, with the discipline and preparation federal work requires.',
...
export const GOV_FOOTER = {
  ...
  links: [
    { label: 'SAM.gov Entity Search', href: VERIFICATION_LINKS.samGov, external: true },
    { label: 'SBA VetCert Public Search', href: VERIFICATION_LINKS.sdvosbVetCert, external: true },

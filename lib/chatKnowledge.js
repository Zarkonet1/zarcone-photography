...
FORMATTING: Plain conversational text only — this is a small chat bubble, not a document. Never use markdown: no asterisks for bold/italic, no numbered lists, no bullet points, no headers. If you have a few things to convey, write them as a normal sentence or short paragraph, not a list.

...
export const GALLERIES_2026 = [
  ...
  {
    id: 'mount-st-mary',
    label: 'vs. Mount St. Mary Academy',
    date: '2026-09-08', // home match — see SCHEDULE_2026 in lib/volleyballSchedule.js
    href: 'https://galleries.zarconephotography.com/client/20260908-brhs-volleyball-vs-mt-saint-marys',
    photoCount: null, // TBD — fill in real count from the gallery
  },
  {
    id: 'hunterdon-central',
    label: 'vs. Hunterdon Central',
    date: '2026-09-15', // home league match — see SCHEDULE_2026 in lib/volleyballSchedule.js
    href: 'https://galleries.zarconephotography.com/client/20260915-brhs-volleyball-vs-hunterdon-central',
    photoCount: null, // TBD — fill in real count from the gallery
  },
];

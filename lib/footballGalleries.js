...
export const GALLERIES_2026 = [
  ...
  {
    id: 'st-joseph-metuchen',
    label: 'vs. St. Joseph (Metuchen)',
    date: '2026-09-05', // Week 2, played at St. Joseph (Metuchen) — see SCHEDULE_2026 in lib/footballSchedule.js
    href: 'https://galleries.zarconephotography.com/client/20260905-brhs-football-vs-st-josephs-metuchen',
    photoCount: 176,
  },
  {
    id: 'hillsborough',
    label: 'vs. Hillsborough',
    date: '2026-09-11', // Week 3, home game — see SCHEDULE_2026 in lib/footballSchedule.js (W 40-14)
    href: 'https://galleries.zarconephotography.com/client/20260911-brhs-football-v-hillsborough',
    photoCount: 162,
  },
  {
    id: 'ridge',
    label: 'vs. Ridge',
    date: '2026-09-18', // Week 4, home game — see SCHEDULE_2026 in lib/footballSchedule.js (W 7-3, first BR win over Ridge since 2015)
    href: 'https://galleries.zarconephotography.com/client/20260918-brhs-football-vs-ridge',
    photoCount: null, // TBD — fill in real count from the gallery
  },
];

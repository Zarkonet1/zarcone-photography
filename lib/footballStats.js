...
export const WEEKLY_BOX_SCORES_2026 = [
  ...
  // artifact. Reported here as NJRB presents it; no press recap exists yet
  // to independently confirm which player scored or the play detail — flag
  // for next sweep to corroborate once one publishes.
  {
    week: 'Week 3',
    ...
    categories: [
      ...
      },
      {
        ...
        rows: [
          ...
          { cells: ['Jasper Schwamberger', "BR's lone INT of the game — NJRB's box score also flags it as returned for a touchdown (not yet detailed in any press recap)"] },
        ],
      },
    ],
    sources: [

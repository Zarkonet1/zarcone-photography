...
// Re-pulled 2026-09-23 sweep from NJRB's team page (now through Week 4,
// Ridge box score njrecordbook.com/football/game/18189/ posted since the
// 09-22 sweep). NJRB's own "Team leaders" module now names Jack Winne the
// INT leader (2, both vs. Ridge) and James Locrotondo the sacks leader
// (1 — tied with Crovelli, Jones and Lorino at 1 each; NJRB picks
// Locrotondo as the displayed leader). NJRB also relabeled its passing
// efficiency column "QBR" (was "Rating") and the numbers changed scale
// (Baxter 90.8 -> 68.6 after a 12/25, 82-yd, 3-INT night) — mirrored as-is.
export const TEAM_LEADERS_2026 = [
  {
    ...
    number: 10,
    value: '713',
    detail: '52.1 comp%, 4 TD, 5 INT — 4 games (NJRB season total)',
  ...
  },
  {
    ...
    number: 11,
    value: '569',
    detail: '97 att, 8 TD, 5.9 YPC — 4 games',
  ...
  },
  {
    ...
    number: 27,
    value: '35',
    detail: '4 TFL, 1 sack, 1 FF — 4 games',
    photo: '/photos/media-day-portraits/27.jpg',
  },
  {
    category: 'Sacks',
    name: 'James Locrotondo',
    number: 4,
    value: '1',
    detail: 'Week 4 vs. Ridge. Tied with Crovelli (#27), Jones (#41) and Lorino at 1 each — NJRB names Locrotondo as the displayed leader',
    photo: '/photos/media-day-portraits/4.jpg',
  },
  {
    ...
    number: 9,
    value: '2',
    detail: 'Both in Week 4 vs. Ridge — the 2nd sealed the 7-3 win late in the 4th (per CJSR). Levash, Locrotondo, Woodring and Schwamberger have 1 each.',
...
export const SEASON_STATS_2026 = {
  gamesPlayed: 4,
  asOf: 'Sep 23, 2026 (through Week 4, vs. Ridge)',
  ...
  passing: {
    ...
    rows: [
      { cells: ['J. Baxter (#10)', 4, '52.1', '68.6', 713, 4, 5] },
      { cells: ['E. Woodring (#5)', 4, '0.0', '0.0', 0, 0, 1] },
    ],
  },
  rushing: {
    columns: ['Player', 'GP', 'Att', 'Yds', 'TD', 'YPC'],
    rows: [
      { cells: ['J. Black (#11)', 4, 97, 569, 8, '5.9'] },
      { cells: ['J. Okolo', 4, 40, 144, 2, '3.6'] },
      { cells: ['E. Woodring (#5)', 4, 10, 70, 1, '7.0'] },
      { cells: ['J. Baxter (#10)', 4, 3, 26, 0, '8.7'] },
      { cells: ['J. Baker', 2, 6, 18, 0, '3.0'] },
      { cells: ['J. LoCrotondo (#4)', 4, 1, 1, 0, '1.0'] },
  ...
  receiving: {
    ...
    rows: [
      { cells: ['E. Woodring (#5)', 4, 17, 242, 2, '14.2'] },
      { cells: ['D. Krizan', 3, 12, 156, 0, '13.0'] },
      { cells: ['A. Lorino', 4, 6, 76, 0, '12.7'] },
      { cells: ['J. Winne (#9)', 4, 2, 70, 1, '35.0'] },
      { cells: ['B. Matos', 4, 5, 45, 0, '9.0'] },
      { cells: ['J. Black (#11)', 4, 3, 41, 0, '13.7'] },
      { cells: ['J. Schwamberger', 3, 1, 30, 1, '30.0'] },
      { cells: ['J. LoCrotondo (#4)', 4, 1, 27, 0, '27.0'] },
      { cells: ['J. Baker', 2, 1, 16, 0, '16.0'] },
      { cells: ['J. Okolo', 4, 1, 6, 0, '6.0'] },
      { cells: ['C. Rutherford', 4, 1, 4, 0, '4.0'] },
    ],
  },
  defense: {
    columns: ['Player', 'GP', 'Tkl', 'Sk', 'TFL', 'INT', 'FF', 'FR'],
    rows: [
      { cells: ['N. Crovelli (#27)', 4, 35, 1, 4, 0, 1, 0] },
      { cells: ['A. Lorino', 4, 26, 1, 4, 0, 0, 0] },
      { cells: ['J. Black (#11)', 4, 21, 0, 5, 0, 0, 0] },
      { cells: ['T. Levash', 4, 18, 0.5, 5, 1, 0, 0] },
      { cells: ['J. LoCrotondo (#4)', 4, 15, 1, 3, 1, 0, 0] },
      { cells: ['E. Woodring (#5)', 4, 13, 0, 1, 1, 0, 0] },
      { cells: ['J. Winne (#9)', 4, 13, 0, 0, 2, 0, 0] },
      { cells: ['J. Jones (#41)', 4, 13, 1, 3, 0, 0, 0] },
      { cells: ['J. Markovitch', 4, 13, 0, 2, 0, 0, 1] },
      { cells: ['J. Okolo', 4, 11, 0, 0, 0, 0, 0] },
      { cells: ['N. Zuckerman', 4, 11, 0, 0, 0, 0, 0] },
      { cells: ['F. Schenk', 4, 10, 0, 0, 0, 0, 0] },
      ...
      { cells: ['C. Rutherford', 4, 3, 0, 0, 0, 0, 0] },
  ...
  returning: {
    ...
    rows: [
      ...
      { cells: ['J. LoCrotondo (#4)', 4, 2, 30, 0, 0] },
      { cells: ['B. Matos', 4, 1, 15, 0, 0] },
      { cells: ['E. Woodring (#5)', 4, 0, 0, 6, 53] },
    ],
  },
  kicking: {
    columns: ['Player', 'GP', 'FGM', 'FGA', 'XPM', 'XPA'],
    rows: [
      { cells: ['P. Lyons', 4, 0, 0, 11, 12] },
    ],
  },
  punting: {
    columns: ['Player', 'GP', 'Punts', 'Yds', 'Avg', 'Long'],
    rows: [
      { cells: ['J. Winne (#9)', 4, 13, 428, '32.9', 46] },
    ],
  },
};

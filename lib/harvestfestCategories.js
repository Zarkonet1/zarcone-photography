...
export const HARVESTFEST_CATEGORIES = [
  ...
  },
  {
    ...
    tileImage: '/photos/i-rvRX82g.jpg',
    ...
    images: [
      { src: '/photos/i-rvRX82g.jpg', alt: 'Senior portrait — Zarcone Photography' },
  ...
  },
  {
    ...
    tileImage: '/photos/EVENT-Zarcone-Photography-0008.jpg',
    blurb: 'Full-day coverage for celebrations, fundraisers, and organizational events.',
    exploreHref: '/events',
    exploreLabel: 'See Events',
    images: [
      { src: '/photos/EVENT-Zarcone-Photography-0008.jpg', alt: 'Event coverage — Zarcone Photography' },

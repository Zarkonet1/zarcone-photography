...
export const TEAM_LEADERS_2026 = [
  {
    ...
    number: 7,
    value: '81',
    detail: '17 in the Sep 2 five-set loss to Westfield; 14 in the Sep 17 loss to Roxbury',
  },
  {
    category: 'Assists',
    name: 'Brooke Krizan',
    number: 14,
    value: '199',
    detail: '39 vs. Westfield, 29 in the Sep 17 loss to Roxbury',
  },
  {
    category: 'Digs',
    name: 'Camille Hilton',
    number: 5,
    value: '170',
    detail: '31 in the Sep 2 loss to Westfield; 25 in the Sep 17 loss to Roxbury',
  },
  {
    category: 'Aces',
    name: 'Margarita Silvar',
...
// Re-pulled fresh from NJRB's team page 2026-09-25 sweep: NJRB had newly
// caught up on several matches that were previously missing from its own
// schedule (documented as lagging at 3-4/2-2 through Sep 10 as of the
// 09-24 sweep) — totals above now reflect games through Sep 22 (11 played).
// Sep 15 (at Hunterdon Central, L 0-2) box score page exists on NJRB but
// reports no individual BR stat line ("No individual stats reported") —
// no WEEKLY_BOX_SCORES_2026 entry added for that match per the
// no-fabrication rule; the result itself is already reflected in
// lib/volleyballSchedule.js.
//
...
export const WEEKLY_BOX_SCORES_2026 = [
  ...
  },
  {
    ...
    opponent: 'vs Roxbury',
    date: 'Sep 17, 2026',
    result: 'L, 1-2 (27-29, 25-17, 20-25)',
    categories: [
      {
        label: 'Box Score',
        columns: ['Player', 'K', 'A', 'D', 'B', 'Ace'],
        rows: [
          { cells: ['Margarita Silvar (#7)', 14, 1, 10, 1, 2] },
          { cells: ['Viktoria Borodkin (#19)', 8, 0, 3, 4, 0] },
          { cells: ['Reese Albano (#2)', 7, 0, 11, 0, 1] },
          { cells: ['Jackie Oram (#25)', 2, 0, 12, 0, 0] },
          { cells: ['Riley Romanak (#8)', 2, 0, 1, 0, 0] },
          { cells: ['Brooke Krizan (#14)', 1, 29, 7, 0, 2] },
          { cells: ['Camille Hilton (#5)', 0, 3, 25, 0, 2] },
          { cells: ['Cecelia Amalfitano', 0, 0, 2, 0, 0] },
          { cells: ['Klaudia Swider (#21)', 0, 0, 0, 0, 0] },
        ],
      },
    ],
    sources: [
      { label: 'NJ Record Book', url: 'https://njrecordbook.com/girls-volleyball/game/19373/' },
    ],
  },
  {
    week: 'Sep 18',
    ...
    date: 'Sep 18, 2026',
    result: 'W, 2-0 (25-12, 25-17)',
    categories: [
      {
        label: 'Box Score',
        columns: ['Player', 'K', 'A', 'D', 'B', 'Ace'],
        rows: [
          { cells: ['Viktoria Borodkin (#19)', 8, 0, 1, 1, 0] },
          { cells: ['Margarita Silvar (#7)', 7, 0, 8, 1, 3] },
          { cells: ['Riley Romanak (#8)', 3, 0, 4, 1, 2] },
          { cells: ['Quinn Levash', 1, 0, 0, 1, 0] },
          { cells: ['Brooke Krizan (#14)', 1, 14, 0, 0, 1] },
          { cells: ['Jackie Oram (#25)', 0, 1, 8, 0, 0] },
          { cells: ['Camille Hilton (#5)', 0, 1, 11, 0, 1] },
          { cells: ['Autumn Sachs (#16)', 0, 0, 1, 0, 1] },
          { cells: ['Bella Locrotondo', 0, 0, 1, 0, 0] },
        ],
      },
    ],
    sources: [
      { label: 'NJ Record Book', url: 'https://njrecordbook.com/girls-volleyball/game/20986/' },
    ],
  },
  {
    week: 'Sep 22',
    opponent: 'at North Hunterdon',
    date: 'Sep 22, 2026',
    result: 'L, 0-2 (16-25, 19-25)',
    categories: [
      {
        label: 'Box Score',
        columns: ['Player', 'K', 'A', 'D', 'B', 'Ace'],
        rows: [
          { cells: ['Margarita Silvar (#7)', 5, 0, 3, 0, 0] },
          { cells: ['Jackie Oram (#25)', 2, 0, 3, 0, 1] },
          { cells: ['Riley Romanak (#8)', 2, 0, 4, 0, 1] },
          { cells: ['Reese Albano (#2)', 1, 0, 1, 0, 0] },
          { cells: ['Viktoria Borodkin (#19)', 1, 0, 1, 1, 0] },
          { cells: ['Autumn Sachs (#16)', 0, 0, 2, 0, 3] },
          { cells: ['Brooke Krizan (#14)', 0, 10, 5, 0, 1] },
          { cells: ['Camille Hilton (#5)', 0, 1, 11, 0, 0] },
          { cells: ['Quinn Levash', 0, 0, 2, 0, 0] },
        ],
      },
    ],
    sources: [
      { label: 'NJ Record Book', url: 'https://njrecordbook.com/girls-volleyball/game/21266/' },
    ],
  },
];

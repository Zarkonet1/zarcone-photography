...
**A composite records a season. A concept explains what it built.**
...
![Built Different — custom concept artwork for Matthew McCann, BRHS Panther Wrestling, by Zarcone Photography](/photos/Built_Different_McCann.jpg)

*"Built Different" — the finished concept piece, in full. Blueprint framing, program branding, and the half-human, half-mechanical figure built around Matthew McCann, BRHS Panther Wrestling.*
...
Concept and campaign artwork like "Built Different" starts at **$450**, with multi-athlete campaigns and full program series scoped and quoted individually based on what the concept actually calls for. That's a different number than a standard composite for a real reason: a composite is built from a session's existing photos and a proven layout process. A concept piece is original development, iteration, and testing, built from nothing but an idea. The design time isn't comparable, so the price shouldn't be either. If you're weighing which one fits your program, [reach out](/about#contact) and we'll scope it honestly rather than upsell you into more than the project needs.

## Where the standard composite still fits

Not every senior needs a fully original concept — and most don't need one. A standard composite is still the right product for a family that wants a strong, clean poster built from a [senior portrait](/senior-portrait-photographer-nj) session or [sports coverage](/sports-photographer-nj): real gear and action shots from the shoot, laid into a design built around the athlete's sport, team colors, and graduation year, with two rounds of revisions included. It starts at **$75**, with team and bulk pricing available for programs ordering multiple, and it's still one of the most requested add-ons to a senior portrait session. If your senior plays a fall sport, [pair it with a fall portrait session](/blog/when-to-book-fall-senior-portraits-nj) and bring the uniform — the same afternoon produces both.
...
Medals end up in a drawer. Uniforms get outgrown or handed down to the next kid on the roster. What doesn't fade is the piece that actually explains what a season meant — not just a photo from it, but the idea behind it. That's what a concept piece is built to outlast.

        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.honeybook.com https://*.elfsight.com https://formspree.io https://vercel.live https://vitals.vercel-insights.com",
              "frame-src 'self' https://*.honeybook.com https://*.elfsight.com https://player.vimeo.com",
              "object-src 'none'",
              "base-uri 'self'",
            ].join('; '),
          },

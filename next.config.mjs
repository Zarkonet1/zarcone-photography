    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.honeybook.com https://*.elfsight.com https://*.elfsightcdn.com https://vercel.live https://www.googletagmanager.com https://www.clarity.ms https://scripts.clarity.ms https://c.clarity.ms",
